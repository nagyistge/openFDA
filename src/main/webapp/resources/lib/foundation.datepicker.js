...
!function( $ ) {
    ...
    var dates = $.fn.fdatepicker.dates = {
        ...
        hu: {
            days: ["Vasárnap", "Hétf?", "Kedd", "Szerda", "Csütörtök", "Péntek", "Szombat", "Vasárnap"],
        ...
        cz: {
            days: ["Ned?le", "Pond?lí", "Úterý", "St?eda", "?tvrtek", "Pátek", "Sobota", "Ned?le"],
            daysShort: ["Ne", "Po", "Út", "St", "?t", "Pá", "So", "Ne"],
            daysMin: ["Ne", "Po", "Út", "St", "?t", "Pá", "So", "Ne"],
            months: ["Leden", "Únor", "B?ezen", "Duben", "Kv?ten", "?erven", "?ervenec", "Srpen", "Zá?í", "?íjen", "Listopad", "Prosinec"],
            monthsShort: ["Led", "Úno", "B?e", "Dub", "Kv?", "?er", "?nc", "Srp", "Zá?", "?íj", "Lis", "Pro"],
            today: "Dnes"
        }
    };
