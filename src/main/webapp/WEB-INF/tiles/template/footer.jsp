    ...
    <div class="row text-right">
      <div class="large-11 push-1 medium-10 small-12 columns">
        <a href="#" class="fc-webicons facebook" data-toggle="tooltip" title="<spring:message code = "footer.soicalIcon.fackbook"/>">
          <img src="/css/webicons-master/webicons/webicon-facebook.svg" id="facebook-icon" width=5% height=5% >
        </a>
        <a href="#" class="fc-webicons twitter" data-toggle="tooltip" title="<spring:message code = "footer.soicalIcon.twitter"/>">
          <img src="/css/webicons-master/webicons/webicon-twitter.svg" id="twitter-icon" width=5% height=5% >
        </a>
        <a href="#" class="fc-webicons linkedin" data-toggle="tooltip" title="<spring:message code = "footer.soicalIcon.linkedin"/>">
          <img src="/css/webicons-master/webicons/webicon-linkedin.svg" id="linkedin-icon" width=5% height=5% >
        </a>
      </div>
    </div>
  </div>
